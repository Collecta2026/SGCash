...
def test_the_balances_table_is_the_first_thing_on_the_dashboard(app):
    ...
    assert html.index("Latest recorded balances") < html.index('class="health'), \
        "the balances table must come first"
    assert html.index("Latest recorded balances") < html.index("Cash position")
...
def test_the_balances_table_is_hidden_from_anyone_without_bank_access(app):
